const stationLevelPressure = {
  station: {
    name: "1st Class Observatory, Bhola",
    station_no: "41951",
    latitude: "22° 41' N",
    longitude: "90° 39' E",
    elevation_m: "4.30 m (above MSL)",
    bar_cistern_height_m_above_msl: "5.49 m (above MSL)",
    bar_cistern_height_m_below_station: "1.19 m (above Station)",
  },
  correction_table: [
    {
      height: 4.3,
